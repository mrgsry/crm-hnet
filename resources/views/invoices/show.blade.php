                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-2 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-lg">HNet Solution</p>
                            <p class="text-gray-600 text-sm">Alamat Perusahaan HNet Solution</p>
                            <p class="text-gray-600 text-sm">Email: info@hnetsolution.com</p>
                        </div>
                        <!-- Customer Info -->
                        <div>
                    ...
                    <div class="mb-8">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-gray-50">
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase">Deskripsi
                                    </th>
                    ...
                    <div class="flex justify-end mt-12">
                        <div class="text-center w-64">
                            ...
                            <p class="font-bold border-b border-gray-400 pb-1">HNet Solution Admin</p>
                        </div>
                    </div>
